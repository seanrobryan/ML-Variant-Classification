...
DVDTxtData = open('/Users/coltonmiller/CADD_Work/Regression/DVDv9_e_20220220.ALLVARTYPES.arr.txt', 'r')
count = 0
data_points = []
...
with open('AllVariantsData20230330.txt','w') as testfile:
    for row in allVariantsToCSV:
        testfile.write(row + '\n')
TODO-RECENT WORK
allVariantData = open('/Users/coltonmiller/CADD_Work/Regression/AllVariantsData20230330.txt', 'r')
count = 0
data_points = [] 
...
diseaseTags = open('/Users/coltonmiller/CADD_Work/Regression/FinalDiseaseTypesUnique-HA.csv', 'r')
disease_points = []
...
with open('MatchedDiseaseVariantsData20230330.txt', 'w') as testfile:
    for row in allVariantsToCSV:
        testfile.write(row + '\n')



DVDTxtData = open('/Users/coltonmiller/CADD_Work/Regression/20220403LikelyBenignVariants.txt', 'r')
count = 0
data_points = []
for line in DVDTxtData:
    # if count > 10:
...
with open('LBVariantsData20230330.txt','w') as testfile:
    for row in allVariantsToCSV:
        testfile.write(row + '\n')

allVariantData = open('/Users/coltonmiller/CADD_Work/Regression/LBVariantsData20230330.txt', 'r')
count = 0
data_points = [] 
for line in allVariantData:
    line = line.strip()
...
with open('LBMatchedDiseaseVariantsData20230330.txt', 'w') as testfile:
    for row in allVariantsToCSV:
        testfile.write(row + '\n')
...
with open('CleanedAllVariantsData20230118.txt','w') as testfile:
...
with open('CleanedProteinPointsConvert20230118.tsv','w') as testfile:
...
CleanedVariantTxtData = open('/Users/coltonmiller/CADD_Work/Regression/CleanedAllVariantsData20230118.txt', 'r')
...
print(data_points)
with open('ProcessedCleanedAllVariantDataPoints20230118.txt', 'w') as testfile:
    for row in data_points:
        testfile.write(row +'\n')
ProteinCoordData = open('/Users/coltonmiller/CADD_Work/Regression/AllVariantsResults20230118.tsv', 'r')

proteinCoords = []
count = 0
with open('/Users/coltonmiller/CADD_Work/Regression/AllVariantsResults20230118.tsv') as f:
    for line in f:
        temp = []
        #l = line.split('\t')
...
proteinCoords_df = pd.read_csv('/Users/coltonmiller/CADD_Work/Regression/results.tsv', sep='\t')
...
with open('Missense_data_points.txt', 'w') as testfile:
    for row in data_points:
        testfile.write(' '.join([str(a) for a in row]) + '\n')

with open('Missense_data_point_benignORpathogenic.txt','w') as testfile2:
    for row in pathogenic_Benign_Dataset:
        testfile2.write(' '.join([str(a) for a in row]) +'\n')

with open('Protein_Coord_All_data_points.txt','w') as testfile:
    for row in proteinCoords:
        testfile.write(row + '\n')
        


variantsDataFile = open('/Users/coltonmiller/CADD_Work/Regression/ProcessedCleanedAllVariantDataPoints.txt',"r")
...
proteinCoordsDataFile = open('/Users/coltonmiller/CADD_Work/Regression/Protein_Coord_All_data_points.txt',"r")
...
with open('AllVariantsWithProteinPos.txt','w') as testfile:
    for row in variantsWithProteinCoordsToCSV:
        testfile.write(row + '\n')


dataToClean = open('/Users/coltonmiller/CADD_Work/Regression/domainsToEditWithClass.csv',"r")
...
with open('CleanedWFS1DomainDataWithClass.csv','w') as testfile:
...
# # # proteinCoordsDataFile = open('/Users/coltonmiller/CADD_Work/Regression/Protein_Coord_data_points.txt',"r")
# # # lines = proteinCoordsDataFile.read().splitlines()
# # # proteinCoordData2D = []
# # # for l in lines:
# # #     arrProteinCoordDataPoint = []
...
missenseAndProteinCoordsDataFile = open('/Users/coltonmiller/CADD_Work/Regression/MissenseWithProteinPos.txt',"r")
...
missenseGeometricDataFile = open('/Users/coltonmiller/CADD_Work/Regression/MissenseWithGeometricData.txt',"r")
...
validMissenseGeometricProteinDataFile = open('/Users/coltonmiller/CADD_Work/Regression/ValidMissenseWithGeometricData.txt',"r")
...
processedValidMissenseGeometricProteinDataFile = open('/Users/coltonmiller/CADD_Work/Regression/ProcessedValidMissenseWithGeometricData.csv',"r")
...
domainBedFile = open('/Users/coltonmiller/CADD_Work/Regression/unipDomain.slim.bed')
...
processedValidMissenseGeometricProteinDataFile = open('/Users/coltonmiller/CADD_Work/Regression/MissingMAFProcessedValidMissenseWithGeometricData.csv')
lines = processedValidMissenseGeometricProteinDataFile.read().splitlines()
data2D = []
for l in lines:
    arrDataPoint = []
